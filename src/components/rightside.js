        ...
        return (
            ...
            <div className="detailContent">
                ...
                <ul className='colour-button' >
                    <li onClick={()=>toogle(0)} className={activeBtn === 0 ? 'activebtn' : "activebtn2" }><span>Furniture1</span></li>
                    <li onClick={()=>toogle(1)} className={activeBtn === 1 ? 'activebtn' : "activebtn2" }><span>Furniture2</span></li>
                    <li onClick={()=>toogle(2)} className={activeBtn === 2 ? 'activebtn' : "activebtn2" }><span>Furniture3</span></li>
                    <li onClick={()=>toogle(3)} className={activeBtn === 3 ? 'activebtn' : "activebtn2" }><span>Furniture4</span></li>
                    <li onClick={()=>toogle(4)} className={activeBtn === 4 ? 'activebtn' : "activebtn2" }><span>Furniture5</span></li>
                </ul>
            </div>
